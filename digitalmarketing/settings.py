...
SECRET_KEY = 'dt_xkvcmg0t-0e0rx@@)pmnck^*m1etw_-9d50kn&lv=4_vpxa'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['guild-systems.herokuapp.com', '127.0.0.1']
...
EMAIL_PORT=587
EMAIL_USE_TLS=True
EMAIL_HOST_USER='guildsystemsbw@gmail.com'
EMAIL_HOST_PASSWORD='Guilded123'
